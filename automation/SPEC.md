...
| candidates  |                                                             |
| Star floor  | stars:>30                                                   |
| Time window | pushed within last 30 days                                  |
...
5. Keep candidates with confidence **≥ 60**
...
| 60-79       | Borderline; included in PR for maintainer review            |
| < 60        | Skip                                                        |
+-------------+-------------------------------------------------------------+
```

**Score inputs:** stars (>30 base, tiers at 50/100/500), recency (30 days),
description quality (≥10 chars), keyword/topic fit, notable org list.

**High-quality bar (≥ 60):** in-scope, deduped, not archived/fork, passes
score threshold.
...
**Title:** `Daily candidates: YYYY-MM-DD (N entries, conf ≥60)`

**README diff:** only entries with confidence ≥ 60:
...
| scout.py    |                                                             |
| automation/ | Search query templates ({date} = 30-day cutoff)             |
| queries.json|                                                             |
...
| Star floor  | stars:>30                                                   |
| Recency     | 30 days (pushed)                                            |
| window      |                                                             |
| PR          | >= 1 high-quality find (confidence >= 60)                   |
| threshold   |                                                             |
...
> **Note:** Confidence floor is ≥ 60 for review-friendly PR volume. Raise
